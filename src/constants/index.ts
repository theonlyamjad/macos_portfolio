      ...
      children: [
        {
          ...
          position: "top-5 left-10",
          description: [
            "A macOS-style portfolio website built with Next.js, where the entire UI mimics a desktop environment , draggable windows, a dock, a Finder for browsing projects, and apps like Terminal, Photos, and Contact.",
            "The goal was to turn a portfolio into an interactive experience rather than a standard scrolling page.",
          ],
        },
        {
          id: 2,
          ...
          kind: "file",
          fileType: "url",
          href: "https://github.com/theonlyamjad/macos_portfolio",
          position: "top-10 right-20",
        },
        {
          id: 3,
          ...
          fileType: "img",
          position: "top-52 right-80",
          imageUrl: "/images/macosportfolio.png",
        },
      ],
    },
  ],
